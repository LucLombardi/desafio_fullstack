...
public class FornecedorEmpresaController {
	...
	@Operation(summary = "Vincular fornecedor a uma empresa", description = "Cria um vínculo entre um fornecedor e uma empresa")
	...
	@Operation(summary = "Desvincular fornecedor de sua empresa", description = "Remove o vínculo entre um fornecedor e a empresa")
	...
	public ResponseEntity<String> desvincularFornecedor(
			...
			@Parameter(description = "ID do fornecedor e ID da Empresa") @PathVariable Long fornecedorId,
